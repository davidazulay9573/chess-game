...
export function stratDetention(tool, king, enemies) {
    ...
    filterEnemies.forEach((enemyTool) => {
        if (tool.location.row == king.location.row &&
            ...
            if (enemyTool.location.col > king.location.col &&
                ...
                if (enemyTool.location.col > tool.location.col) {
                    ...
                    filterBlack.forEach((blacktool) => {
                        if (blacktool.location.row == king.location.row) {
                            if (blacktool.location.col < enemyTool.location.col &&
                    ...
                    filterWhite.forEach((whitetool) => {
                        if (whitetool.location.row == king.location.row) {
                            if (whitetool.location.col < enemyTool.location.col &&
        ...
        if (tool.location.col == king.location.col &&
